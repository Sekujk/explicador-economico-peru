...
def test_parse_period_name_setiembre_abreviatura_peruana():
    # El BCRP usa "Set" (setiembre) en vez de "Sep" para septiembre.
    assert _parse_period_name("Set.2026", "mensual") == date(2026, 9, 1)
    assert _parse_period_name("01.Set.26", "diaria") == date(2026, 9, 1)
